                ...
                <div class="bg-white px-4 py-3 border-b border-gray-300">
                    <form action="{{ route('classes.update', $class->id) }}" method="POST">
                        ...
                        <div class="bg-white px-4 py-3 flex justify-between items-center">
                            <button type="submit"
                                class="inline-block bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Update</button>
                            <a href="{{ route('classes.index') }}" class="text-blue-500 hover:text-blue-600 font-medium">Back</a>
                        </div>
                    </form>
                </div>
            </div>
