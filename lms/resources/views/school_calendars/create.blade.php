...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-md rounded-lg">
        ...
        <h2 class="text-xl font-semibold text-gray-800">Create School Calendar Entry</h2>
                    <a href="{{ route('school_calendars.index') }}" class="text-blue-500 hover:text-blue-600 font-medium">Back</a>
                </div>
        <div class="p-4">
            <form action="{{ route('school_calendars.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="event_date" id="event_date" required class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
